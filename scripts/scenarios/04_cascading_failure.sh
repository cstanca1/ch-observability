...
echo
echo "=================================================="
echo " Scenario 4: Cascading Failure"
echo "=================================================="
echo
...
echo "  - Simulates auth degrading first, then checkout and payment"
echo
echo "What to show:"
echo "  - Grafana Service Dependency Propagation dashboard"
echo "  - Grafana Incident Timeline dashboard"
echo "  - auth -> checkout -> payment dependency chain"
echo "  - dependency_status values"
echo "  - Root cause versus downstream impact"
echo
...
echo "Restarting generator for cascading failure scenario..."
docker compose up -d --build generator >/dev/null
echo "Generator restarted."
echo

echo "Scenario 4 is now active."
...
echo "FROM logs"
echo "WHERE incident_mode = 'cascading_failure'"
echo "GROUP BY service, dependency_status"
echo "ORDER BY avg_latency_ms DESC;"
echo
